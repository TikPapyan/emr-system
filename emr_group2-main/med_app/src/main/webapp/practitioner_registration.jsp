...
<%@ page import="com.example.med_app.QualificationDAO" %><%--
...
<body>
    ...
    <div class="image">
        <img src="images/practitioner_logo.svg" alt="Italian Trulli">
    </div>

    <div>
        <form action="/PractitionerRegister" method="post" enctype="multipart/form-data">
            <div class="container">

                <h1>Register a Practitioner</h1>
                ...
                <input class="std" type="password" placeholder="Enter Password" id="t4" name="psw" required><br>

                <input class="std" type="password" placeholder="Confirm Password" id="t5" name="confirm psw" required><br>
                <select class="std" name="qualification" required>
                    <option value="" disabled selected>Qualification</option>
                    <%=
                        QualificationDAO.getQualificationOptions()
                    %>
                </select><br>
